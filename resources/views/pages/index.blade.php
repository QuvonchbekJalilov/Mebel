                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="hero-image mx-auto wow fadeInUp" data-wow-delay="0.2s">
                                <img src="assets/images/hero/hero-banner-1.png" alt="img">
                            </div>
                        </div>
                        <!-- Single Slider -->
                        <div class="swiper-slide">
                            ...
                            <div class="hero-image mx-auto wow fadeInUp" data-wow-delay="0.2s">
                                <img src="assets/images/hero/04.png" alt="img">
                            </div>
                        </div>
                        <!-- Single Slider -->
                        <div class="swiper-slide">
                            ...
                            <div class="text-center d-block">
                                <a href="shop.html" class="outline-pill-btn wow fadeInUp" data-wow-delay="0.1s">
                                    Explore Products
                                    <svg xmlns="http://www.w3.org/2000/svg" width="78" height="19"
                                        viewBox="0 0 78 19" fill="none">
                                        <path
                            ...
                            <div class="hero-image mx-auto wow fadeInUp" data-wow-delay="0.2s">
                                <img src="assets/images/hero/03.png" alt="img">
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="product-card feature-card h-calc">
                                    <div class="top-card">
                                        <div class="price-section">
                                            ...
                                            @endphp
                                            @if ($discount)
                                                <h4 class="price discounted">${{ $product->price }}</h4>
                                                <h4 class="price text-color-primary">${{ $product->getDiscountedPrice() }}</h4>
                                            @else
                                                <h4 class="price text-color-primary">${{ $product->price }}</h4>
                                            @endif
                                        </div>
                                        <button class="wishlist-icon">
                                            <img src="{{ asset('assets/images/icon/wish-icon-2.png') }}" alt="img">
                                        </button>
                                    </div>
                                    <div class="product-img-card feature-img-card">
                                        <a href="shop-details.html" class="zoomImg">
                                            <img src="{{ asset('assets/images/product/' . $product->image) }}" alt="{{ $product->{'title_' . $locale} }}">
                                        </a>
                                        @if ($discount)
        ...
        <div class="row g-4">
            <div class="col-xl-12">
                <div class="deals-card">
                    <div class="row align-items-center g-4">
                        ...
                        <div class="col-xl-6">
                            <div class="deals-content">
                                ...
                                <div class="section-title">
                                    <h4 class="title">Deal of the Week Let's <span
                                            class="outline-text">Shopping</span> Today</h4>
                                </div>
                    ...
                    <div class="shape-one heartbeat2">
                        <img src="assets/images/gallery/deal-shape-3.svg" alt="img">
                    </div>
                    <div class="shape-two routedOne">
                        <img src="assets/images/gallery/deal-shape-4.png" alt="img">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        @foreach($news as $article)
                            <div class="swiper-slide">
                                <div class="news-card">
                                    ...
                                    <a href="{{ route('news.show', $article->id) }}" class="read-more-text">Read More
