                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="hero-caption-one position-relative mx-auto wow fadeInUp" data-wow-delay="0.0s">
                                <h4 class="title">{{__('app.index1')}}
                                    <span class="outline-text">{{__('app.index2')}}</span> {{__('app.index3')}}
                                </h4>
                            </div>
                        ...
                        <div class="swiper-slide">
                            <div class="hero-caption-one position-relative mx-auto wow fadeInUp" data-wow-delay="0.0s">
                                <h4 class="title">
                                    {{__('app.index5')}}
                                    <span class="outline-text">{{__('app.index6')}}</span> {{__('app.index7')}}
                                </h4>
                            </div>
                            <div class="text-center d-block wow fadeInUp" data-wow-delay="0.1s">
                                <a href="/shop" class="outline-pill-btn ">
                        ...
                        <div class="swiper-slide">
                            <div class="hero-caption-one position-relative mx-auto wow fadeInUp" data-wow-delay="0.0s">
                                <h4 class="title">
                                    {{__('app.index8')}}
                                    <span class="outline-text">{{__('app.index9')}}</span> {{__('app.index10')}}
                                </h4>
                            </div>
...
<section class="feature-area feature-bg position-relative">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h4 class="title">{{__('app.index11')}}</h4>
                </div>
            </div>
        </div>
        <div class="row">
                            ...
                            <div class="product-card feature-card h-calc">
                                ...
                                <div class="cart-card feature-cart-card d-none d-md-block">
                                    ...
                                    <div class="button-section">
                                        <form id="add-to-cart-form-first" action="{{ route('cart.add') }}" method="POST">
                                            @csrf
                                            <input type="hidden" name="product_id" value="{{ $product->id }}">
                                            <input type="hidden" id="hidden-quantity-first-desktop" name="qty" value="1"> <!-- Unique Hidden input for quantity -->
                                ...
                                <div class="button-section d-block d-md-none">
                                    <form id="add-to-cart-form-mobile" action="{{ route('cart.add') }}" method="POST">
                                        @csrf
                                        <input type="hidden" name="product_id" value="{{ $product->id }}">
                                        <input type="hidden" id="hidden-quantity-mobile" name="qty" value="1"> <!-- Unique Hidden input for quantity -->
                                        <button type="submit" class="cart-btn" name="submit" value="addtocart">{{__('app.cart')}}</button>
                                    </form>
                                </div>
                            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        qtyContainers.forEach((container, index) => {
            ...
            const form = container.closest('.button-section').querySelector('form');

            let hiddenQtyInput;

            // Determine which hidden input to update based on the form's id
            if (form.id === 'add-to-cart-form-first') {
                hiddenQtyInput = document.getElementById('hidden-quantity-first-desktop');
            } else if (form.id === 'add-to-cart-form-mobile') {
                hiddenQtyInput = document.getElementById('hidden-quantity-mobile');
            }

            // Initialize the quantity
            qtyInput.value = hiddenQtyInput.value;
            ...
            // Update hidden input quantity directly when qtyInput changes
            qtyInput.addEventListener('input', () => {
                hiddenQtyInput.value = qtyInput.value;
            });

            // Update hidden quantity field just before the form is submitted
                ...
                <div class="category-card h-calc gallery-one wow fadeInUp" data-wow-delay="0.0s">
                    ...
                    <div class="collection-card lg">
                        <a href="/shop">
                            ...
                            <p class="pera text-color-tertiary">35 {{__('app.category')}}</p>
                        </a>
                    </div>
                </div>
            </div>
                        ...
                        <div class="category-card h-calc gallery-two wow fadeInUp" data-wow-delay="0.1s">
                            ...
                            <div class="collection-card">
                                <a href="/shop">
                                    ...
                                    <p class="pera text-color-tertiary">48 {{__('app.category')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="category-card h-calc gallery-two wow fadeInUp" data-wow-delay="0.2s">
                            ...
                            <div class="collection-card">
                                <a href="/shop">
                                    ...
                                    <p class="pera text-color-tertiary">24 {{__('app.category')}}</p>
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="category-card h-calc gallery-three wow fadeInUp" data-wow-delay="0.0s">
                    ...
                    <div class="collection-card sm">
                        <a href="/shop">
                            ...
                            <p class="pera text-color-tertiary">15 {{__('app.category')}}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="category-card h-calc gallery-three wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <div class="collection-card sm">
                        <a href="/shop">
                            ...
                            <p class="pera text-color-tertiary">22 {{__('app.category')}}</p>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="category-card h-calc gallery-three wow fadeInUp" data-wow-delay="0.2s">
                    ...
                    <div class="collection-card sm">
                        <a href="/shop">
                            ...
                            <p class="pera text-color-tertiary">32 {{__('app.category')}}</p>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xxl-6">
                <div class="section-with-button">
                    <div class="section-title position-relative wow fadeInUp" data-wow-delay="0.0s">
                        <h4 class="title">{{__('app.index12')}} <span class="outline-text">{{__('app.index13')}}</span></h4>
                        <div class="shape routedOne">
                            <img src="/image/BRB-1.png" alt="img" style="width: 80px;border-radius: 50%;height: 80px;">
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-6 col-xl-4 col-sm-6">
                        <div class="product-card best-product-card">
                            ...
                            <div class="product-img-card best-product-img-card">
                                <a href="{{ route('shop_details', $product->id) }}" class="zoomImg">
                            ...
                            <a href="{{ route('shop_details', $product->id) }}">
                            ...
                            <div class="button-section">
                                <form id="add-to-cart-form" action="{{ route('cart.add') }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="product_id" value="{{ $product->id }}">
                                    <input type="hidden" id="hidden-quantity-best" name="qty" value="1"> <!-- Hidden input for quantity -->
                                    <button type="submit" class="cart-btn" name="submit" value="addtocart">{{__('app.cart')}}</button>
                                </form>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        qtyContainers.forEach(container => {
            ...
            const plusBtn = container.querySelector('.qty-btn-plus');
            const qtyInput = container.querySelector('.input-qty');
            const hiddenQtyInput = document.getElementById('hidden-quantity-best');
...
<section class="news-area bottom-padding1">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title">
                    <h4 class="title">{{__('app.index14')}}</h4>
                </div>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="news-card">
                                ...
                                <a href="{{ route('blog.details', $article->id) }}" class="read-more-text">{{__('app.read_more')}}
