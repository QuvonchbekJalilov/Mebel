                        ...
                        <div class="breadcrumb-text">
                            ...
                            <nav aria-label="breadcrumb" class="breadcrumb-nav wow fadeInUp" data-wow-delay="0.0s">
                                <ul class="breadcrumb listing">
                                    <li class="breadcrumb-item single-list"><a href="/" class="single">Home</a>
                                    </li>
                                    <li class="breadcrumb-item single-list" aria-current="page"><a
                                            href="javascript:void(0)" class="single active">Blog</a></li>
                                </ul>
                            </nav>
                        </div>
                    </div>
                        ...
                        <div class="row g-4">
                            <div class="col-sm-6">
                                <div class="news-card">
                                    ...
                                    <div class="news-content">
                                        <a href="{{route('blog_details')}}">
                                            <h4 class="news-title line-clamp-2">Modern studio apartment design bedroom
                                                and living space</h4>
                                        </a>
                                    </div>
                                    <a href="{{route('blog_details')}}" class="read-more-text">Read More <svg
                            ...
                            <div class="col-sm-6">
                                <div class="news-card">
                                    ...
                                    <div class="news-content">
                                        <a href="{{route('blog_details')}}">
                                            <h4 class="news-title line-clamp-2">Cafe with coffee tables as sofas plants
                                                and shelves</h4>
                                        </a>
                                    </div>
                                    <a href="{{route('blog_details')}}" class="read-more-text">Read More <svg
                        ...
                        <div class="news-filter">
                            <div class="search-filter-section">
                                ...
                                <div class="search-section">
                                    ...
                                    <div class="search-box mt-26 mb-0">
                                        <input class="custom-form-control" type="search" name="search"
                                            placeholder="Search">
                                        <div class="icon">
                                ...
                                <div class="search-section">
                                    ...
                                    <div class="arrival-product">
                                        <a href="shop-details.html">
                                            <div class="product-details">
                                                <div class="product-img">
                                                    <img src="assets/images/gallery/arrival-img-1.png" alt="img">
                                                    <div class="special-icon2">
                                                        <div class="icon">
                                                            <img src="assets/images/icon/wish-icon.png" alt="img">
                                                        </div>
                                                        <div class="icon icon-2">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="16"
                                                                height="16" viewBox="0 0 16 16" fill="none">
                                                                <path
                                                                    d="M5.3194 11.8968C6.15343 12.4747 6.44355 13.1708 6.18931 13.9469C5.96189 14.6413 5.3021 15.1189 4.58091 15.1115C3.84027 15.1037 3.1861 14.6066 2.979 13.8946C2.7559 13.1267 3.05942 12.4271 3.8433 11.9141C3.79963 11.8673 3.74342 11.8851 3.695 11.8816C2.96344 11.8275 2.37109 11.2457 2.31532 10.5245C2.25781 9.78128 2.73428 9.11722 3.46022 8.95239C3.60852 8.91865 3.61458 8.8689 3.58345 8.73825C2.96041 6.13348 2.34213 3.52872 1.72557 0.923089C1.70049 0.817098 1.66245 0.773837 1.54441 0.776865C1.17171 0.78595 0.79858 0.781624 0.425881 0.779461C0.166029 0.778163 0.000433208 0.625883 8.42434e-07 0.394435C-0.000431523 0.164285 0.165597 0.00508321 0.423719 0.00292014C0.936937 -0.00097338 1.45059 -0.00097338 1.96381 0.00292014C2.19253 0.00465059 2.3257 0.113237 2.37974 0.336465C2.54577 1.02389 2.71093 1.71131 2.86875 2.4009C2.89901 2.53241 2.94528 2.58432 3.09055 2.58303C3.9929 2.57524 4.89524 2.57697 5.79802 2.58173C5.9152 2.58216 5.96449 2.54496 6.0034 2.43464C6.48981 1.04638 7.77523 0.130108 9.22625 0.129676C10.6786 0.129243 11.9709 1.04638 12.4534 2.42988C12.4958 2.55101 12.5498 2.58216 12.6705 2.58173C13.5676 2.57697 14.4644 2.5787 15.3615 2.57913C15.7602 2.57957 15.9072 2.77121 15.812 3.16273C15.3749 4.96197 14.9378 6.7612 14.5002 8.56001C14.32 9.30065 13.8271 9.68394 13.0492 9.68394C9.99586 9.68481 6.94293 9.68394 3.88956 9.68437C3.47709 9.68437 3.21032 9.86823 3.1152 10.2135C3.00105 10.6279 3.28771 11.0532 3.71402 11.0995C3.79444 11.1081 3.87573 11.1077 3.95658 11.1077C7.39345 11.1081 10.8303 11.1081 14.2672 11.1

                                                        </div>
                                                    </div>
                                                ...
                                                <div class="product-info">
                                                    <h4 class="name line-clamp-1">Affinity Queen Poster Bed</h4>
                                                    <div class="price-section">
                                                        <h4 class="price discounted">$640</h4>
                                                        <h4 class="price text-color-primary">$570</h4>
                                                    </div>
                                        ...
                                        <a href="shop-details.html">
                                            <div class="product-details">
                                                <div class="product-img">
                                                    <img src="assets/images/gallery/arrival-img-2.png" alt="img">
                                                    <div class="special-icon2">
                                                        <div class="icon">
                                                            <img src="assets/images/icon/wish-icon.png" alt="img">
                                                        </div>
                                                ...
                                                <div class="product-info">
                                                    <h4 class="name line-clamp-1">Mid-Century Modern Cane</h4>
                                                    <div class="price-section">
                                                        <h4 class="price text-color-primary">$640</h4>
                                                    </div>
                                                    <div class="ratting-section">
                                                        <div class="all-ratting">
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="14"
                                        ...
                                        <a href="shop-details.html">
                                            <div class="product-details">
                                                <div class="product-img">
                                                    <img src="assets/images/gallery/arrival-img-3.png" alt="img">
                                                    <div class="special-icon2">
                                                        <div class="icon">
                                                            <img src="assets/images/icon/wish-icon.png" alt="img">
                                                        </div>
                                                ...
                                                <div class="product-info">
                                                    <h4 class="name line-clamp-1">Rift Gogan Sofa Large</h4>
                                                    <div class="price-section">
                                                        <h4 class="price text-color-primary">$640</h4>
                                                    </div>
                                                    <div class="ratting-section">
                                ...
                                <div class="search-section">
                                    ...
                                    <div class="arrival-product latest-post">
                                        <a href="{{route('blog_details')}}">
                                            <div class="product-details">
                                                <div class="product-img-two">
                                                    <img src="assets/images/news/latest-post-1.png" alt="img">
                                                </div>
                                                <div class="product-info">
                                                    <h4 class="line-clamp-2">
                                                        <span class="title-effect name">Dark living room intrior with
                                                            leather sofa and table</span>
                                                    </h4>
                                                    <div class="date">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                                            ...
                                                            <path
                                                                ...
                                                                fill="#AD8C5C" />
                                                            <path
                                                                d="M9.79737 5.83917C9.5178 5.83917 9.28906 5.61021 9.28906 5.33037C9.28906 5.05052 9.52098 4.82156 9.80055 4.82474C10.0738 4.82792 10.2993 5.0537 10.3025 5.32719C10.3057 5.60703 10.0769 5.83917 9.79737 5.83917Z"
                                                                fill="#AD8C5C" />
                                                            <path
                                        ...
                                        <a href="{{route('blog_details')}}">
                                            <div class="product-details">
                                                <div class="product-img-two">
                                                    <img src="assets/images/news/latest-post-2.png" alt="img">
                                                </div>
                                                <div class="product-info">
                                                    <h4 class="line-clamp-2">
                                                        <span class="title-effect name">Concrete Wall Clock With Leather
                                                            Stripe, Modern</span>
                                                    </h4>
                                                    <div class="date">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                        ...
                                        <a href="{{route('blog_details')}}">
                                            <div class="product-details">
                                                <div class="product-img-two">
                                                    <img src="assets/images/news/latest-post-3.png" alt="img">
                                                </div>
                                                <div class="product-info">
                                                    <h4 class="line-clamp-2">
                                                        <span class="title-effect name">Pleased black girl wearing
                                                            trendy sport shoes</span>
                                                    </h4>
                                                    <div class="date">
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
                                                            viewBox="0 0 13 13" fill="none">
                                    ...
                                    <div class="all-tags-cloud">
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                                <p class="pera">Chairs</p>
                                            </a>
                                        </div>
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                                <p class="pera">Special Offer</p>
                                            </a>
                                        </div>
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                                <p class="pera">Bedroom</p>
                                            </a>
                                        </div>
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                                <p class="pera">Cabinet</p>
                                            </a>
                                        </div>
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                        ...
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                                <p class="pera">Mattresses</p>
                                            </a>
                                        </div>
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                                <p class="pera">Office</p>
                                            </a>
                                        </div>
                                        <div class="single-tag">
                                            <a href="javascript:void(0)">
                                                <p class="pera">Accent Furniture</p>
                                            </a>
                                        </div>
                                    </div>
                                </div>
