                        ...
                        <form action="{{ route('products.update', $product->id) }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate onchange="updateEditorContent()">
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="price" name="price" value="{{ $product->price }}" placeholder="Narx" required>
                                    <div class="invalid-feedback">
                                        Ushbu maydon to'ldirilishi shart.
                                    </div>
                                </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input type="checkbox" class="form-check-input" id="best_seller" name="best_seller" {{ $product->best_seller ? 'checked' : '' }}>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="imagePreview" class="mt-3">
                                    @if ($product->image)
                                        <img src="{{ asset('storage/' . $product->image) }}" class="img-thumbnail preview-image" style="max-width: 200px;">
                                    @endif
                                </div>
                            </div>
