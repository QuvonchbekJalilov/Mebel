<x-layouts.admin>
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Chegirmani Tahrirlash</h4>
                </div>
                <div class="col-lg-6">
            ...
            <div class="col-lg-12">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h5 class="mb-0" style="color: white !important;">Chegirmani Tahrirlash Formasi</h5>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('discounts.update', $discount->id) }}" method="post" class="needs-validation" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row mb-4">
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder="Chegirma nomi" value="{{ old('name', $discount->name) }}" required>
                                    <div class="invalid-feedback">
                                        Ushbu maydon to'ldirilishi shart.
                                    </div>
                                </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control" id="percentage" name="percentage" placeholder="Foiz" value="{{ old('percentage', $discount->percentage) }}">
                                    <div class="invalid-feedback">
                                        Ushbu maydon to'ldirilishi shart.
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="sum" name="sum" placeholder="So'm" value="{{ old('sum', $discount->sum) }}">
                                    <div class="invalid-feedback">
                                        Ushbu maydon to'ldirilishi shart.
                                    </div>
                                </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="from" name="from" value="{{ old('from', $discount->from ? \Carbon\Carbon::parse($discount->from)->toDateString() : '') }}" required>
                                    <div class="invalid-feedback">
                                        Ushbu maydon to'ldirilishi shart.
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <input type="date" class="form-control" id="to" name="to" value="{{ old('to', $discount->to ? \Carbon\Carbon::parse($discount->to)->toDateString() : '') }}" required>
                                    <div class="invalid-feedback">
                                        Ushbu maydon to'ldirilishi shart.
                                    </div>
                                </div>
